...
public class InvisibleWallCutTheFruit : MonoBehaviour
{
    ...
    private float StartPositionZRight;
    private float StartPositionZLeft;
    ...
    void Start()
    {
        StartPositionZLeft = targetL.position.z;
        StartPositionZRight = targetR.position.z;
    }
    private void Update()
    {
        targetR.position = new Vector3(targetR.position.x, targetR.position.y, StartPositionZRight);
        targetL.position = new Vector3(targetL.position.x, targetL.position.y, StartPositionZLeft);
